...
dbscan_y_pred = dbscan.fit_predict(pca_x_train)
optics_y_pred = optics.fit_predict(pca_x_train)
...
ax.scatter(
    xs=boston_dataframe[0], ys=boston_dataframe[1], zs=boston_dataframe[2], c=dbscan_y_pred
)
# ax.text(0, 0, "DBSCAN")

ax2 = fig.add_subplot(222, projection="3d")
ax2.scatter(
    xs=boston_dataframe[0], ys=boston_dataframe[1], zs=boston_dataframe[2], c=optics_y_pred
)
# ax2.text(0, 0, "OPTICS")
